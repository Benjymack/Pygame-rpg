...
while True:
    ...
    game = pygame.surface.Surface((limage.get_width()*16,limage.get_height()*16))
    ...
    while True:
        ...
        screen.blit(game, (screen.get_width()/2-player.pos[0],screen.get_height()/2-player.pos[1]))
        #Draw inventory
