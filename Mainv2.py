...
def simple_camera(camera, target_rect):
    ...
    return Rect(-l+(lwidth/2), -t+(lheight/2), w, h)
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        '''
        for mob in mobs:
            if distance(self.pos, mob.pos) < 20:
...
class Mob(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        screen.blit(self.image,camera.apply(self))#self.pos)
...
class Goal(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if distance(self.pos,player.pos) < 15 and len(mobs) == 0:
            pygame.quit()
            print('You win!')
...
spriteTileGoal = pygame.image.load("Graphics/TGoal.png")
...
lheight = limage.get_height()*BLOCKSIZE
lwidth = limage.get_width()*BLOCKSIZE
del limage
...
#Camera functions
camera = Camera(simple_camera, lwidth, lheight)
...
while True:
    ...
    for j in range(limage.get_height()):
        ...
        for i in range(limage.get_width()):
            ...
            if px[0] == 100:
                goal = Goal(i*BLOCKSIZE, j*BLOCKSIZE,spriteTileGoal)
            ...
            if px[2] == 255:
                m = Mob(i*BLOCKSIZE,j*BLOCKSIZE,spriteMobBugs,2,5,20,1)
            if px[2] == 192:
